...
<section id="prodetails" class="section-p1">
    ...
    <div class="single-pro-image">
        <img src="img/th (4).jpg" width="100%" id="MainImg" alt="" height="460px">
        ...
        <div class="small-img-group">
            ...
            <div class="small-img-col1">
                <img src="img/th (5).jpg" width="100%" class="small-img" alt="">
            </div>
            
            <div class="small-img-col1">
                <img src="img/th (6).jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col1">
    ...
    <h6>HOME / T-Shirt</h6>
  <h4>Men's Python Fashion T Shirt</h4>
  <h2>780</h2>
