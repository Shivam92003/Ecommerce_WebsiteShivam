...
<section id="prodetails" class="section-p1">
    ...
    <div class="single-pro-image">
        <img src="img/shirt2.jpg" width="100%" id="MainImg" alt="" height="460px">
        ...
        <div class="small-img-group">
            ...
            <div class="small-img-col1">
                <img src="img/shirt4.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col1">
                <img src="img/shirt5.jpg" width="100%" class="small-img" alt="">
            </div>
