...
<section id="prodetails" class="section-p1">
    ...
    <div class="single-pro-image">
        <img src="img/shirt8.webp" width="100%" id="MainImg" alt="" height="460px">

        <div class="small-img-group">
            <div class="small-img-col1">
                <img src="img/shirt8.webp" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col1">
                <img src="img/shirt11.jpg" width="100%" class="small-img" alt="">
            </div>
            
            <div class="small-img-col1">
                <img src="img/shirt12.jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col1">
                <img src="img/shirt1.jpg" width="100%" class="small-img" alt="">
            </div>
    ...
    <h6>HOME / T-Shirt</h6>
  <h4>Men's Xyython Fashion T Shirt</h4>
  <h2>780</h2>
