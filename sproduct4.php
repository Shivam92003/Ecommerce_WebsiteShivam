...
<section id="prodetails" class="section-p1">
    ...
    <div class="single-pro-image">
        <img src="img/th (7).jpg" width="100%" id="MainImg" alt="" height="460px">

        <div class="small-img-group">
            <div class="small-img-col1">
                <img src="img/th (7).jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col1">
                <img src="img/th (8).jpg" width="100%" class="small-img" alt="">
            </div>
            
            <div class="small-img-col1">
                <img src="img/th (9).jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col1">
                <img src="img/th (11).jpg" width="100%" class="small-img" alt="">
            </div>
