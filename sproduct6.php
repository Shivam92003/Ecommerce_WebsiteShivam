...
<section id="prodetails" class="section-p1">
    ...
    <div class="single-pro-image">
        <img src="img/th (9).jpg" width="100%" id="MainImg" alt="" height="460px">
        ...
        <div class="small-img-group">
            ...
            <div class="small-img-col1">
                <img src="img/th (14).jpg" width="100%" class="small-img" alt="">
            </div>
            <div class="small-img-col1">
                <img src="img/th (10).jpg" width="100%" class="small-img" alt="">
            </div>
